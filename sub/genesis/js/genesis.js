    ...
    var genesis = {
        ...
        section4Fn: function(){
            ...
            var sAni = 0;
                ...
                function aniFormatFn(){
                    $('#section4 img').stop().animate({ left: -100+'%', opacity:0 },1000);
                    
                }
                
                function aniFn(){
                    $('#section4 img').stop().animate({ left: 0, opacity:1 },2000);
        ...
        section6Fn: function(){
            ...
            var sAni = 0;
                ...
                function aniFormatFn(){
                    $('#section6 img').stop().animate({ left: -100+'%', opacity:0 },1000);
                    
                }
                
                function aniFn(){
                    $('#section6 img').stop().animate({ left: 0, opacity:1 },2000);
...
})(jQuery,window,document);//genesis.js